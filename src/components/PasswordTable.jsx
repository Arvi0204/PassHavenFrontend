                                ...
                                <div key={item._id} className="block xl:hidden overflow-hidden">
                                    <h2 id={`accordion-collapse-heading-${item._id}`}>
                                        <button
                                            ...
                                            className="flex items-center justify-between w-full p-5 font-semibold bg-blue-800 text-white hover:bg-blue-600 gap-3 transition duration-300 rounded-t-lg"
                                            aria-expanded={isAccordionOpen}
                                            aria-controls={`accordion-collapse-body-${item._id}`}
                                        >
                                            <span><a href={url} target="_blank" rel="noopener noreferrer">
                                                {getDisplayURL(item.url)}
                                            </a></span>
                                            <svg
                                                className={`w-3 h-3 text-white transition-transform duration-300 ${isAccordionOpen ? "rotate-180" : ""
                                                    }`}
                                    ...
                                    <div
                                        ...
                                        className={`transition-max-h duration-500 ease-in-out overflow-hidden ${isAccordionOpen ? "max-h-96 p-4 bg-blue-100 rounded-b-lg" : "max-h-0"
                                            }`}
                                    ...
                                    >
                                        <div>
                                            <div className="flex justify-between items-center text-blue-900 font-medium text-sm">
                                                <span className="text-black tracking-wide truncate overflow-hidden whitespace-nowrap">{item.username}</span>
                                                <img
                                            ...
                                            <div className="flex justify-between items-center mt-2 text-blue-900 font-medium text-sm">
                                                ...
                                                <div className="flex gap-2 items-center cursor-pointer mx-5">
                                                    ...
                                                    >
                                                        {isPasswordVisible ? (
                                                            <EyeOffIcon className="h-5 w-5 text-blue-900" />
                                                        ) : (
                                                            <EyeIcon className="h-5 w-5 text-blue-900" />
                                                        )}
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="flex justify-center items-center gap-3 mt-4">
                                                <button
                                                    className="flex items-center gap-3 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-1"
                                                    onClick={() => editPassword(item._id)}
                                                >
                                                    Edit Password
                                                    <img
                                                ...
                                                <button
                                                    className="flex items-center gap-3 text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-1"
                                                    onClick={() => deletePassword(item._id)}
                                                >
                                                    Delete Password
                                                    <img
