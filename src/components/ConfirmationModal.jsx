      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-xl bg-white rounded-lg shadow dark:bg-gray-800 p-6"
          ...
          >
            ...
            <p className="mb-4 text-xl text-center text-gray-500 dark:text-gray-300">{message}</p>
